...
Pong is a 2D game originally programmed by Atari that came out in 1972. It features two paddles, controlled by players, with the goal of getting the ball past your opponent's edge. The player who scores 10 points first wins the game.
...
You will also need to setup Lua in your system. Download Lua from this [link](https://excellmedia.dl.sourceforge.net/project/luabinaries/5.2.4/Tools%20Executables/lua-5.2.4_Win64_bin.zip)
